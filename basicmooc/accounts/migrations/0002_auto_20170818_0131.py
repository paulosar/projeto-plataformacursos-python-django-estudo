# -*- coding: utf-8 -*-
# Generated by Django 1.11.4 on 2017-08-18 01:31
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='user',
            name='username',
            field=models.CharField(max_length=30, unique=True, validators=[django.core.validators.RegexValidator(re.compile('^[\\w.@+-]+$', 32), 'O nome de usuário só pode conter letras e digitos.', 'invalid')], verbose_name='Nome de Usuário'),
        ),
        migrations.AddField(
